...
rename_resources_in_file "infra/application.yaml" "${APP_NAME}" "${COMPONENT_NAME}"
rename_resources_in_file "infra/appenv.yaml" "${APP_NAME}" "${COMPONENT_NAME}"
rename_resources_in_file ".github/workflows/ci.yaml" "${APP_NAME}" "${COMPONENT_NAME}"
rename_resources_in_file "setup.sh" "${APP_NAME}" "${COMPONENT_NAME}"
